...
Public Class salary_advance
    ...
    Private Function LoadTransactionAmount() As Decimal
        ...
        Try
            Dim query As String = "SELECT SalaryAmount FROM LoanRepaymentTbl WHERE UserName = @Username"
    ...
    Private Sub RequestLoanBtn_Click(sender As Object, e As EventArgs) Handles RequestLoanBtn.Click
       ...
       borrowDatePicker.Value = DateTime.Now Then
        ...
        If Integer.TryParse(RepaymentTb.Text, repayment) Then
            ...
            If repayment > 3 Then
                MessageBox.Show("Repayment period must be less than or equal to 3 months.", "Invalid Input", MessageBoxButtons.OK, MessageBoxIcon.Warning)
                Return
            End If
        Else
    ...
    Private Sub MaxAmountBtn_Click(sender As Object, e As EventArgs) Handles MaxAmountBtn.Click
        ...
        If Decimal.TryParse(AmountTb.Text, amount) Then
            Dim loanApplied As Decimal = (amount * 2) / 3
            LoanAppliedTb.Text = loanApplied.ToString()
        Else
    ...
    Private Sub MemNameTb_TextChanged(sender As Object, e As EventArgs) Handles MemNameTb.TextChanged
    ...
    Private Sub lblDateJoined_Click(sender As Object, e As EventArgs) Handles lblDateJoined.Click
